...
module.exports = {
  ...
  JWT_SECRET: process.env.JWT_SECRET || "you-il-access-secret-change-me",
  ...
  EMAIL_FROM_EMAIL: process.env.EMAIL_FROM_EMAIL || "no-reply@example.com",
  EMAIL_FROM_NAME: process.env.EMAIL_FROM_NAME || "You-il",
